...
async fn get_projects_paginated(
    ...
    loop {
        ...
        let _ = debug_utils::save_api_response("gitlab", "projects", &response_text);
        let page_projects: Vec<GitlabProject> = serde_json::from_str(&response_text)?;
